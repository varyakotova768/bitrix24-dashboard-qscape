...
<!--     Иконка: Выполняется -->
    <svg v-else-if="status.type === 'inProgress'" class="status-icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M1 13L6.83333 8L1 3M9.16667 13L15 8L9.16667 3" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
...
// Пропсы: данные статуса
const props = defineProps({
  status: { type: Object, required: true }
})

// Класс бейджа в зависимости от цвета
